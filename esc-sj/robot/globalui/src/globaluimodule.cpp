...
global_note(PyObject* /*self*/, PyObject* args)
{
    ...
    if(err != KErrNone){
		...
		return Py_BuildValue("i", noteId);
    }
}

extern "C" PyObject*
global_notehide(PyObject* /*self*/, PyObject* args)
{
    TInt noteId = -1;

    if(!PyArg_ParseTuple(args, "i", &noteId)){
        return NULL;
    }
...
extern "C" {
    static const PyMethodDef globalui_methods[] = {
        ...
        {"global_notehide", (PyCFunction)global_notehide, METH_VARARGS, NULL},
    ...
    DL_EXPORT(void) init_myglobalui(void)
    {
        Py_InitModule("myglobalui", (PyMethodDef*)globalui_methods);
    }
}  /* extern "C" */

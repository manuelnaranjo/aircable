...
878 IF $3[3] <> 48 THEN 546
879 ALARM 5
880 IF $3[0] = 53 THEN 815
881 B = status
882 IF $3[0] = 54 THEN 209
883 IF B < 1 THEN 207
884 IF $3[0] = 55 THEN 216
885 IF B > 10 THEN 244
886 A = disconnect 0
887 A = disconnect 1
888 $3[0] = 54
889 GOTO 509

890 IF $3[0] = 53 THEN 897
891 A = pioset ($8[1]-48);
892 A = pioset ($8[0]-48);
893 $3[0] = 56
894 A = link 3;
